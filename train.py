...
parser.add_argument('--div2k_hr_path', type=str, default='/data/sr_datasets/data_1/DIV2K/DIV2K_train_HR', help = '')
parser.add_argument('--div2k_lr_path', type=str, default='/data/sr_datasets/data_1/DIV2K/DIV2K_train_LR_bicubic', help = '')
parser.add_argument('--set5_hr_path', type=str, default='/data/sr_datasets/benchmark/Set5/HR', help = '')
